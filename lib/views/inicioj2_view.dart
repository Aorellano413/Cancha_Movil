...
class InicioJ2View extends StatelessWidget {
  const InicioJ2View({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Sede - La Jugada 2"),
          centerTitle: true,
          leading: IconButton(
        ...
        body: Consumer2<CanchasJugada2Controller, ReservaController>(
          builder: (context, canchasController, reservaController, child) {
            return ListView(
              padding: const EdgeInsets.all(16),
              children: [
                const Text(
                  "¡Reserva tu cancha en La Jugada 2!",
