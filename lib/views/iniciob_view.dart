...
class InicioBView extends StatelessWidget {
  const InicioBView({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: Scaffold(
        ...
        body: Consumer2<CanchasBiblosController, ReservaController>(
          builder: (context, canchasController, reservaController, child) {
            return ListView(
              padding: const EdgeInsets.all(16),
              children: [
                const Text(
                  "¡Reserva tu cancha en Biblos!",
